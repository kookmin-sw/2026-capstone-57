...
- [ ] 5. 매칭 서비스 구현
  ...
  - [ ] 5.2 매칭 점수 계산 엔진 구현 (MVP: 단순 동선 겹침)
  ...
  - [ ] 5.4 배치 매칭 실행 로직 구현
    ...
    - 시간표 기반 동선 시간대 겹침으로 매칭 (AI 미사용, 프로필 속성/매칭 범위 미적용)
    ...
    - _요구사항: 4.1, 4.2, 4.3, 4.4, 4.5, 4.6, 4.7, 4.11, 4.12, 4.13, 4.14, 4.15_

  - [ ]* 5.5 Property 11, 12, 15, 41 속성 테스트: 배치 매칭 규칙
    - **Property 11: 배치 매칭 - 빈 슬롯 매칭 규칙**
    - **Property 12: 매칭 주기 불변식**
    - **Property 15: 매칭 성사 시 양쪽 알림 전송**
    - **Property 41: 매칭 주기 연장 - 양쪽 동의 필수**
    - **검증 대상: 요구사항 4.2, 4.3, 4.4, 4.5, 4.6, 4.7, 4.11, 4.13, 4.14, 4.15, 12.1**
