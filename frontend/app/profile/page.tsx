...
const user = {
  ...
  studentYear: "23학번",
  studentId: "20230001",
  hobbies: ["코딩", "독서", "러닝", "카페투어"],
  personality: ["INTJ", "계획적", "호기심"],
  level: 3,
  exp: 65, // percentage to next level
  totalMatches: 7,
  completedMatches: 5,
  diaryStreak: 12,
}
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              <div className="w-14 h-14 rounded-2xl bg-primary/20 flex items-center justify-center ring-2 ring-primary/30">
                <span className="text-2xl">{user.profileEmoji}</span>
              </div>
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1.5">
                  ...
                  <span className="text-[10px] text-muted-foreground">{user.exp}%</span>
                </div>
              </div>
        ...
        <div className="grid grid-cols-3 gap-2">
          <Card className="border-0 shadow-sm">
            <CardContent className="p-3 text-center">
              ...
              <p className="text-lg font-bold text-foreground">{user.completedMatches}</p>
              <p className="text-[10px] text-muted-foreground">완료 매칭</p>
            </CardContent>
          </Card>
          <Card className="border-0 shadow-sm">
            <CardContent className="p-3 text-center">
          ...
          <Card className="border-0 shadow-sm">
            <CardContent className="p-3 text-center">
              ...
              <p className="text-lg font-bold text-foreground">{user.diaryStreak}</p>
              <p className="text-[10px] text-muted-foreground">일기 연속</p>
            </CardContent>
          </Card>
        </div>
