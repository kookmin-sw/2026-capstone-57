...
VENUE_NODES = [
    ...
    },
    {
        ...
        "source": "VENUE",
        "name": "용두리",
        "typeActivity": ["OUTDOOR"],
        "description": "용두리, 캠퍼스 내 자연 속 휴식 공간, 산책하며 대화하기 좋은 곳",
        "operatingHours": "24시간",
    },
    {
        "nodeId": "uuid-5",
    ...
    },
    {
        ...
        "name": "북서쪽 운동장",
        "typeActivity": ["OUTDOOR"],
        "description": "경상관 앞쪽 운동장, 벤치 있음, 가볍게 앉아 대화하기 좋은 공간",
        "operatingHours": "24시간",
    },
    {
        "nodeId": "uuid-9",
        ...
        "name": "북동쪽 운동장",
        "typeActivity": ["OUTDOOR"],
        "description": "경영관 앞쪽 운동장, 벤치 있음, 가볍게 앉아 대화하기 좋은 공간",
        "operatingHours": "24시간",
    },
    {
        "nodeId": "uuid-10",
...
BUILDING_PLACE_NODES = [
    {
        ...
        "name": "북악관 로비",
        "typeActivity": ["LOUNGE", "CONVENIENCE_STORE", "RESTAURANT", "CAFE"],
        "description": "북악관(N2동) 1층 로비, 간식과 음료 구매 가능",
    ...
    },
    {
        ...
        "source": "BUILDING_PLACE",
        "name": "공학관 로비",
        "typeActivity": ["LOUNGE", "CONVENIENCE_STORE", "CAFE", "RESTAURANT"],
        "description": "공학관(W1동) 로비, 간식과 음료 구매 가능",
        "operatingHours": "24시간",
        "buildingName": "공학관",
        "floor": 1,
    },
    {
        ...
        "description": "조형관(예술대학) 1층 매점, 간식과 음료 구매 가능",
    ...
    },
    {
        ...
        "source": "BUILDING_PLACE",
        "name": "미래관 자주스",
        "typeActivity": ["STUDY_ROOM", "REST_ROOM"],
    ...
    },
    {
        ...
        "source": "BUILDING_PLACE",
        "name": "복지관 3층 휴게공간",
        "typeActivity": ["REST_ROOM"],
        "description": "복지관(S1동) 3층 휴게 공간",
        "operatingHours": "월-금 09:00-22:00",
        "buildingName": "복지관",
        "floor": 4,
    },
    {
