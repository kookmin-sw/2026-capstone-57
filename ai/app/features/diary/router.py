...
[규칙]
1. 질문은 1개만 생성하세요.
2. 일정에 있는 구체적인 활동을 언급하며, 그때 실제로 무엇을 했는지/어떤 일이 있었는지 물어보세요.
3. 친근하고 부담 없는 해요체를 사용하세요.
4. 감정보다는 오늘 실제로 겪은 일, 에피소드, 사건에 초점을 맞추세요.
5. 예/아니오로 답할 수 없는 열린 질문을 하세요.
6. "오늘 어땠어요?" 같은 막연한 질문 대신, "알고리즘 수업에서 뭐 배웠어요?" 같은 구체적 질문을 하세요.
"""
...
8. 오늘 실제로 한 일, 만난 사람, 있었던 일에 초점을 맞추세요.
"""
