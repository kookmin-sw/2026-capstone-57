...
[미션 생성 핵심 원칙]
1. 동선 우선: 반드시 두 사용자의 동선이 겹치는 건물에 있는 장소를 최우선으로 선택하세요. 겹치는 건물에 적합한 장소가 없는 경우에만 다른 건물의 장소를 선택하세요.
2. 부담 없는 활동: 대학생이 처음 만나도 어색하지 않을 가벼운 활동을 제안하세요.
3. 구체적 장소: 반드시 제공된 장소 목록 중 하나를 선택하세요.
4. 시간대 고려: 두 사용자의 공통 시간대에 맞는 활동을 제안하세요.
5. 관심사 반영: 두 사용자의 관심사와 성격을 고려하여 자연스러운 활동을 제안하세요.
6. 친근한 톤: 미션 설명은 친근하고 자연스러운 해요체로 작성하세요.
6. 해당 장소를 선정한 이유를 적어주세요.
